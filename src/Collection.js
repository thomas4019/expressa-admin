...
var Collection = React.createClass({
	componentDidMount: function() {
		...
		this.req1 = axios.get('http://localhost:3000/api/' + collectionName + '/index')
		this.req2 = axios.get('http://localhost:3000/api/' + collectionName + '/schema')
	...
	render: function() {
		...
		if (this.state && this.state.data) {
			...
			var contents = <BootstrapTable data={data} striped={true} hover={true} condensed={true}>
